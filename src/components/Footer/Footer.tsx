...
const Footer = (props: Props) => {
  ...
  return (
    <>
      <div className="w-full flex flex-col md:flex-row items-center md:items-start justify-around px-4 md:px-12 py-6">
        ...
        <div className="flex flex-col items-start justify-between w-full sm:w-fit">
          <div className="my-2 md:my-1 w-full">
            <h3
            ...
            <p
              className={`${f_inter_400.className} flex flex-col items-start justify-start leading-6 text-base font-light text-white p-2`}
            >
          ...
          <div className="my-2 md:my-1 w-full">
            ...
            <p
              className={`${f_inter_400.className} flex flex-col items-start justify-start w-full leading-6 text-base font-light text-white p-2`}
            >
